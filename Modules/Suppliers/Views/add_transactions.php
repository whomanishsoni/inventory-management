        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <?php echo form_open(route_to('suppliers.store_transaction', $suppliersId), ['id' => 'transaction-add', 'method' => 'post', 'autocomplete' => 'off']); ?>
                        <div class="row">
                            <div class="col-12">
                                <!-- Customer Name -->
                                <div class="form-group">
                                    <label for="supplier_name"><?= lang('App.customer_name') ?></label>
                                    <input type="text" class="form-control" name="supplier_name" id="supplier_name"
                                        value="<?= esc($suppliersName) ?>" readonly />
                                </div>

                                <!-- Customer ID (Hidden) -->
                                <input type="hidden" name="customer_id" value="<?= esc($suppliersId) ?>" />
