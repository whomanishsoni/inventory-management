                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="supplier_name" id="supplier_name"
                                        placeholder="<?= lang('App.supplier_name') ?>" autofocus />
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="supplier_address" id="supplier_address"
                                        placeholder="<?= lang('App.supplier_address') ?>"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="supplier_notes" id="supplier_notes"
                                        placeholder="<?= lang('App.supplier_notes') ?>"></textarea>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#country_id,#state_id,#city_id').on('change', function () {
            var $this = $(this);
            if ($this.val() !== "") {
