...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?php echo lang('App.add_supplier') ?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><?php echo lang('App.add_supplier') ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?= lang('App.add_supplier') ?></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <?php echo form_open(route_to('suppliers.store'), ['id' => 'supplier-add', 'method' => 'post', 'autocomplete' => 'off']); ?>
                            <div class="row">
                                <div class="col-12">
                                    <!-- Supplier Name -->
                                    <div class="form-group">
                                        <label for="supplier_name"><?= lang('App.supplier_name') ?></label>
                                        <input type="text" class="form-control" name="supplier_name" id="supplier_name" placeholder="<?= lang('App.supplier_name') ?>" autofocus />
                                    ...
                                    <div class="form-group">
                                        <label for="supplier_contact_person"><?= lang('App.supplier_contact_person') ?></label>
                                        <input type="text" class="form-control" name="supplier_contact_person" id="supplier_contact_person" placeholder="<?= lang('App.supplier_contact_person') ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="supplier_email" id="supplier_email" placeholder="<?= lang('App.supplier_email') ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="supplier_phone" id="supplier_phone" placeholder="<?= lang('App.supplier_phone') ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="supplier_address" id="supplier_address" placeholder="<?= lang('App.supplier_address') ?>"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="supplier_pincode" id="supplier_pincode" placeholder="<?= lang('App.supplier_pincode') ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="supplier_notes" id="supplier_notes" placeholder="<?= lang('App.supplier_notes') ?>"></textarea>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= url('/suppliers') ?>" onclick="return confirm('Are you sure you want to leave?')" class="btn btn-flat btn-danger"><?= lang('App.cancel') ?></a>
                            </div>
                        <?php echo form_close(); ?>
                    </div>
                    <!-- /.card-body -->
