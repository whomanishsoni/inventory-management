...
class Purchases extends AdminBaseController {
    ...
    public function editPurchases($id)
    {
        ...
        $purchaseItems = $purchaseItemsModel->select('purchase_items.*,variations.variation_name, variation_values.variation_value')
                                            ->join('variations', 'variations.id = purchase_items.variation_id')
                                            ->join('variation_values', 'variation_values.id = purchase_items.variation_value_id')
    ...
    //                 // Get the actual variation value name
    //                 $variationValue = $variationValuesModel->find($variation->variation_value_id);
    //                 if ($variationValue) {
    //                     $variation->variation_value_name = strtolower($variationValue->variation_value);
    //                     $variation->variation_product_name = $product->product_name . ' - ' . $variation->variation_value_name;
    //                     $result[] = $variation;
    //                 }
    //             }
    //         } else {
    ...
    public function searchProducts()
    {
        ...
        $productVariationsModel->select('id, product_id, variation_sku_code, variation_product_name, variation_id, variation_value_id, variation_brand_id, variation_unit_id, variation_buying_price, variation_customer_price, variation_sale_price, product_variation_status, created_at, updated_at');
