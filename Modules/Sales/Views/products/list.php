                        ...
                        <table id="products" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo ($row->sub_category_id == 0) ? 'No Sub Category' : $row->sub_category_name; ?>
                                    </td>
                                    <td>
                                        <?php if ($row->has_variation == 1): ?>
                                        <span class="badge badge-success">Yes</span>
                                        <?php elseif ($row->has_variation == 0): ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= url(route_to('products.delete', $row->id)) ?>"
                                            ...
                                            title="<?php echo lang('App.delete_product') ?>" data-toggle="tooltip"><i
