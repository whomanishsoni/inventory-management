...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?php echo lang('App.edit_unit') ?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><?php echo lang('App.edit_unit') ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?= lang('App.edit_unit') ?></h3>
                    </div>
                    <!-- /.card-header -->

                    <div class="card-body">
                        <?php echo form_open(route_to('units.update', $unit->id), ['id' => 'unit-edit', 'method' => 'post', 'autocomplete' => 'off']); ?>
                            <div class="form-group">
                                <label for="unit_name"><?= lang('App.unit_name') ?></label>
                                <input type="text" class="form-control" name="unit_name" id="unit_name" placeholder="<?= lang('App.unit_name') ?>" value="<?= $unit->unit_name ?>" autofocus />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="unit_abbreviation" id="unit_abbreviation" placeholder="<?= lang('App.unit_short_name') ?>" value="<?= $unit->unit_abbreviation ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="unit_status" id="unit_status">
                                    <option value="active" <?= ($unit->unit_status === 'active') ? 'selected' : '' ?>><?= lang('App.active') ?></option>
                                    <option value="inactive" <?= ($unit->unit_status === 'inactive') ? 'selected' : '' ?>><?= lang('App.inactive') ?></option>
                                </select>
