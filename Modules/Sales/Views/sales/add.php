...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?php echo lang('App.add_new_sale') ?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo url('/') ?>"><?php echo lang('App.home') ?></a></li>
                    <li class="breadcrumb-item active"><a
                            href="<?php echo url('/sales-management/sales') ?>"><?php echo lang('App.sales') ?></a>
                    </li>
                    <li class="breadcrumb-item active"><?php echo lang('App.add_new_sale') ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <?= form_open(route_to('sales.store'), ['id' => 'sales-add', 'method' => 'post', 'autocomplete' => 'off']); ?>
    <div class="container-fluid">
        <div class="row">
            <!-- Left column -->
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-danger"
                                        ...
                                        <option value="" selected><?= lang('App.select_customer') ?></option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="purchase_date"><?= lang('App.sale_date') ?></label>
                                    <input type="date" class="form-control" name="sale_date" id="sale_date"
                                        value="<?= date('Y-m-d') ?>" required />
                                    <?= isset($validation) && $validation->getError('sale_date') ? '<p class="text-danger mt-2">' . esc($validation->getError('sale_date')) . '</p>' : '' ?>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sales_status"><?= lang('App.select_sales_status') ?></label>
                                    <select class="form-control" name="sales_status" id="sales_status">
                                        <option value="" selected><?= lang('App.select_sales_status') ?></option>
                                        <option value="completed"><?= lang('App.completed') ?></option>
                                        <option value="pending"><?= lang('App.pending') ?></option>
                                        <option value="canceled"><?= lang('App.canceled') ?></option>
                                    </select>
                                    <?= isset($validation) && $validation->getError('sales_status') ? '<p class="text-danger mt-2">' . esc($validation->getError('purchase_status')) . '</p>' : '' ?>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchSalesOrderNumber() {
            fetch('<?= site_url(route_to('sales.generate_sales_order_number')) ?>')
