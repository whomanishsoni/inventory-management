...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?php echo lang('App.add_variation_value') ?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <?= $variationId ?>
                    <li class="breadcrumb-item active"><?php echo lang('App.add_variation_value') ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?= lang('App.add_variation_value') ?></h3>
                    </div>
                    <!-- /.card-header -->

                    <div class="card-body">
                        <?php echo form_open(route_to('variation-values.store', $variationId), ['id' => 'variation-value-add', 'method' => 'post', 'autocomplete' => 'off']); ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="variation_value" id="variation_value"
                                placeholder="<?= lang('App.variation_value') ?>" autofocus />
                        ...
                        <div class="form-group">
                            <label for="variation_value_status"><?= lang('App.variation_value_status') ?></label>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?= url('/product-management/variation-values/list/' . $variationId) ?>"
