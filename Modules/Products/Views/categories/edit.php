...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?php echo lang('App.edit_category') ?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><?php echo lang('App.edit_category') ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?= lang('App.edit_category') ?></h3>
                    </div>
                    <!-- /.card-header -->

                    <div class="card-body">
                        <?php echo form_open(route_to('categories.update', $category->id), ['id' => 'category-edit', 'method' => 'post', 'autocomplete' => 'off']); ?>
                            <div class="form-group">
                                <label for="category_name"><?= lang('App.category_name') ?></label>
                                <input type="text" class="form-control" name="category_name" id="category_name" placeholder="<?= lang('App.category_name') ?>" value="<?= $category->category_name ?>" autofocus />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="category_description" id="category_description" placeholder="<?= lang('App.category_description') ?>" value="<?= $category->category_description ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_status" id="category_status">
                                    <option value="active" <?= ($category->category_status === 'active') ? 'selected' : '' ?>><?= lang('App.active') ?></option>
                                    <option value="inactive" <?= ($category->category_status === 'inactive') ? 'selected' : '' ?>><?= lang('App.inactive') ?></option>
                                </select>
