...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?php echo lang('App.add_sub_category') ?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><?php echo lang('App.add_sub_category') ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?= lang('App.add_sub_category') ?></h3>
                    </div>
                    <!-- /.card-header -->

                    <div class="card-body">
                        <?php echo form_open(route_to('sub-categories.store'), ['id' => 'sub-category-add', 'method' => 'post', 'autocomplete' => 'off']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sub_category_name" id="sub_category_name"
                                placeholder="<?= lang('App.sub_category_name') ?>" autofocus />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sub_category_description"
                                ...
                                placeholder="<?= lang('App.sub_category_description') ?>" />
...
$(document).ready(function() {
    ...
    $('#sub-category-add').validate({
        ...
        messages: {
            ...
            sub_category_status: {
                required: "Please select the sub category status",
            },
        },
    });
});
