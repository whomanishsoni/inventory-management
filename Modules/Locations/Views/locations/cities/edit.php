...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><?php echo lang('App.edit_city') ?></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><?php echo lang('App.edit_city') ?></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?= lang('App.edit_city') ?></h3>
                    </div>
                    <!-- /.card-header -->

                    <div class="card-body">
                        <?php echo form_open(route_to('cities.update', $city->id), ['id' => 'city-edit', 'method' => 'post', 'autocomplete' => 'off']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city_name" id="city_name"
                                placeholder="<?= lang('App.city_name') ?>" value="<?= ucfirst($city->city_name); ?>" autofocus />
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="city_status" id="city_status">
                                <option value="active" <?= ($city->city_status === 'active') ? 'selected' : '' ?>>
                                    <?= lang('App.active') ?></option>
                                <option value="inactive" <?= ($city->city_status === 'inactive') ? 'selected' : '' ?>>
