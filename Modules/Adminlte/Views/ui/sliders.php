...
<?= $this->section('css') ?>
<!-- Ion Slider -->
<link rel="stylesheet" href="<?php echo assets_url('admin') ?>/plugins/ion-rangeslider/css/ion.rangeSlider.min.css">
<!-- bootstrap slider -->
<link rel="stylesheet" href="<?php echo assets_url('admin') ?>/plugins/bootstrap-slider/css/bootstrap-slider.min.css">
<?=  $this->endSection() ?>
...
<!-- Ion Slider -->
<script src="<?php echo assets_url('admin') ?>/plugins/ion-rangeslider/js/ion.rangeSlider.min.js"></script>
<!-- Bootstrap slider -->
<script src="<?php echo assets_url('admin') ?>/plugins/bootstrap-slider/bootstrap-slider.min.js"></script>
<script>
  $(function () {
    /* BOOTSTRAP SLIDER */
