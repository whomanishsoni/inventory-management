            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?= lang('App.edit_customer') ?></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <?php echo form_open(route_to('customers.update', $customer->id), ['id' => 'customer-edit', 'method' => 'post', 'autocomplete' => 'off']); ?>
                        <div class="row">
                            <div class="col-12">
                                <!-- Customer Name -->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customer_name" id="customer_name"
                                        placeholder="<?= lang('App.customer_name') ?>"
                                        value="<?= $customer->customer_name ?>" autofocus />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="customer_email" id="customer_email"
                                        placeholder="<?= lang('App.customer_email') ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customer_phone" id="customer_phone"
                                        placeholder="<?= lang('App.customer_phone') ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="customer_address" id="customer_address"
                                        placeholder="<?= lang('App.customer_address') ?>"><?= $customer->customer_address ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customer_pincode"
                                        id="customer_pincode" placeholder="<?= lang('App.customer_pincode') ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="customer_status" id="customer_status">
                                <option value="active"
                                    <?= ($customer->customer_status === 'active') ? 'selected' : '' ?>>
                                    <?= lang('App.active') ?></option>
                                <option value="inactive"
                                    <?= ($customer->customer_status === 'inactive') ? 'selected' : '' ?>>
